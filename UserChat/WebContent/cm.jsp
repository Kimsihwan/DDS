	...
	<nav class="navbar navbar-default" style="margin-top: 10px;">
		<div class="collapse navbar-collapse"
			...
			<ul class="dongari">
				...
				<li>&nbsp;&nbsp;&nbsp;<a href="#"><span style="background-color:#FFE08C">친목동아리</span></a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <h3>미슐랭</h3>
          <p>안녕하세요~!~!~!<br>
			미슐랭동아리 소개와 새로운 부원을 모집합니다!!<br>
			-동아리 목적 : 스트레스 해소, 친목 도모<br>
			-활동 내용 : 맛집탐방, 여행, 그 외 자치활동<br>
			-모집 인원 : 미정<br>
			-부원 조건 : 신입생, 복학생 모두 환영<br>
			-면접<br>
			-회비 사용 내역 공개<br>
			-모든 활동은 부원들의 투표로 진행<br>
			-동아리 활동 참여 열심히 할 수 있는 사람 우대<br>
          </p>
